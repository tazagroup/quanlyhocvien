...
export class KhoahocService {
  ...
  getKhoahocBySlug(slug: string) {
    return this.http.post(this.urlApi + `/qlhocvien-khoahoc/`,{slug}).pipe(
      map((data: any) => {
  ...
  getKhoahocById(id: string) {
    return this.http.post(this.urlApi + `/qlhocvien-khoahoc/findid`,{id}).pipe(
      map((data: any) => {
        this._khoahoc.next(data);
        return data;
      })
  ...
  getDanhmucDetail(slug: string) {
    return this.http.get(this.urlApi + `/qlhocvien-danhmuc/${slug}`).pipe(
      map((data: any) => {
